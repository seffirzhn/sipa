              ...
              <div class="col-md-8 col-lg-6 col-xl-5">
                  <div class="card overflow-hidden">
                      ...
                      <div class="card-body p-4">
                          <div class="p-3">
                              <?php echo form_open(CI_RECOVERY_PATH,array("class"=>"recovery-form form-horizontal mt-4 ","data-parsley-validate"=>"true","method"=>"post"));?>
                                  <div class="recovery-info">
                                    <?php echo $this->session->flashdata("errormessage")?>
                                  </div>
                                  <div class="form-group">
                                      <label for="username">Nama Pengguna / Email</label>
                                      <?php echo form_input(array("id"=>"username","name"=>"username","value"=>set_value("username"),"class"=>"form-control","data-parsley-required"=>"true","placeholder"=>"Nama Pengguna / Email","autocomplete"=>"off"));?>
                                  </div>
