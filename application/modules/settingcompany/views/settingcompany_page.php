<div class="row" id="data-tablesettingapp">
	<div class="col-md-12">
	  <?php 
    ...
    ?>
      ...
      <div class="card-body">
        <div class="table-toolbar display-none"></div>
...
<script type="text/javascript">
  $(document).ready(function(){
	 Ajaxpaging.init({target:"#data-tablesettingapp",url:<?php echo json_encode($actions)?>,simplesearch:true});
  });
</script> 
