...
<div class="row" id="data-tablenotification">
  <div class="col-md-12">
    <div class="col-md-12">
      ...
      <div class="card-toolbar panel-toolbar">
        <form class="searchform mb-0" action="javascript:;">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group m-b-5">
                <input type="text" placeholder="Cari Judul" class="form-control input-sm" name="search_title"/>
              </div>
            </div>
            <div class="col-md-5">
              <div class="form-group m-b-5">
                <input type="text" placeholder="Cari Pemberitahuan" class="form-control input-sm" name="search_notification"/>
              </div>
            </div>
          </div>
        </form>
...
<script type="text/javascript">
  $(document).ready(function(){
    Ajaxpaging.init({target:"#data-tablenotification",url:<?php echo json_encode($actions)?>});
  });
</script> 
