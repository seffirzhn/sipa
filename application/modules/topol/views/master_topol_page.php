          ...
          <div class="row">
            <div class="col-md-2">
              <div class="form-group mb-1">
                <?php echo form_dropdown("search_tahun",$listtahun,date("Y"),array("class"=>"select-picker form-control","data-style"=>"btn btn-outline-secondary waves-effect"));?>
              </div>
            </div>
            <div class="col-md-10"> 
              <div class="form-group mb-1">
                <input type="text" placeholder="Cari Judul" class="form-control input-sm" name="search_judul"/>
              </div>
            </div>
          </div>
        </form>
