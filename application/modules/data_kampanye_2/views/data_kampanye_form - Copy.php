  ...
  <div class="card-body">
    <div class="form-body ">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label class="control-label">File RAB </label>
            <div>
              <div class="m-b-5">
...
<script type="text/javascript">
  $(document).ready(function(){
    var num_file = <?php echo $listrincian->num_rows()+1?>;
    for (var i = 1; i < num_file; i++) {
      Browsefile.init({target:"#data-tabledata_kampanye .forminput #newfilerincian"+i,text:"Max. 10MB"});
    }
    Browsefile.init({target:"#data-tabledata_kampanye .forminput #newfile",text:"Max. 10MB"});
