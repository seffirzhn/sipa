        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group " >
              <?php echo form_input(array("name"=>"newjam_mulai","id"=>"jam_mulai","value"=>$jam_mulai,"class"=>"form-control input-md input-range jam_mulai","placeholder"=>"Dari Jam","data-parsley-required"=>"true","data-parsley-errors-container"=>"#errtglkampanye"));?>
              <span class="input-group-addon input-group-prepend input-group-append" ><span class="input-group-text">s/d</span></span>
              <?php echo form_input(array("name"=>"newjam_selesai","id"=>"jam_selesai","value"=>$jam_selesai,"class"=>"form-control input-md input-range jam_selesai","placeholder"=>"Sampai Jam","data-parsley-required"=>"true","data-parsley-errors-container"=>"#errtglkampanye"));?>
            </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered ">
                <thead>
                  <tr>
                    <th width="7%">#</th>
                    <th width="29%">Nama Tokoh Politik</th>
              ...
              <table class="table table-bordered " id="table-dokumentasi">
                <thead>
                  <tr>
                    ...
                    <th width="10%" style="text-align: center"><button type="button" class="btn btn-success btn-sm btn-tambah-rincian-dok"><i class="ti-plus"></i><span class="hidden-sm hidden-xs"></span></button></th>
                  </tr>
                </thead>
...
<div id="dropdowntopol" class="d-none">
  <div class="form-group">
    <?php echo form_dropdown('newtopol[]',$listrinciantopol,null, array("data-parsley-class-handler"=>".dropdown-topol","data-parsley-errors-container"=>"#errtopol","data-parsley-required"=>"true","class"=>"select-picker form-control ","data-style"=>"dropdown-topol btn btn-outline-secondary waves-effect","data-live-search"=>"true","data-size"=>"5"));?>
  </div>
</div>
