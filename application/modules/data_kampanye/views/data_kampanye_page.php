          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group mb-1">
                <?php echo form_dropdown("search_paslon",$listpaslon,null,array("class"=>"select-picker form-control","data-style"=>"btn btn-outline-secondary waves-effect","data-size"=>"5"));?>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group mb-1">
