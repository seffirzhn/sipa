            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        <li>
                            <a href="<?php echo site_url(CI_ADMIN_PATH)?>" link="<?php echo site_url(CI_ADMIN_PATH)?>" namelink="BERANDA" class="linkajax waves-effect"><i class="ti-home"></i><span>Dashboard</span></a>
                        </li>
                        <?php echo $buildMenusidebar;?>
                        <li ><a class="linklogout" link="<?php echo site_url('profile/logout')?>" href="javascript:;"><i class="ti-power-off"></i><span class="title">Keluar</span></a></li>
                    </ul>
                </div>
                <!-- Sidebar -->
            </div>
